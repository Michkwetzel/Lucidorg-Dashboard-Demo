...
class ReminderTemplateWidget_ORG extends ConsumerWidget {
  const ReminderTemplateWidget_ORG({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        SimpleTextFieldGray(
          ...
          onTextChanged: (text) => ref.read(reminderEmailTemplateProvider.notifier).updateEmailFrom(text),
          validator: (text) {
        ...
        SimpleTextFieldGray(
          ...
          onTextChanged: (text) => ref.read(reminderEmailTemplateProvider.notifier).updateSubjectText(text),
          validator: (text) {
            if (text == null || text.isEmpty) {
        ...
        BodyEmailTemplateEdit(
          ...
          onChanged: (value) => ref.read(reminderEmailTemplateProvider.notifier).updateEmailTemplate(value),
          validator: (text) {
            if (text == null || text.isEmpty) {
