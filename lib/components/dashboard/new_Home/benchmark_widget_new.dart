...
class BenchmarkWidgetNew extends ConsumerWidget {
  BenchmarkWidgetNew({
    super.key,
  });
      ...
      child: Column(
        ...
        children: [
          Align(
            ...
            child: Text('Benchmark:', style: TextStyle(fontFamily: "OpenSans", fontWeight: FontWeight.w400, fontSize: 30, color: Color(0xFF494949)))),
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: OverallDepertmentBenchmarkWidget(),
              ),
              SizedBox(height: 35),
