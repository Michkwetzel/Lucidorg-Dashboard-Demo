...
const kH2PoppinsRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 27);
const kH2PoppinsMedium = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 27);

const kH3PoppinsLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w300, fontSize: 24);
const kH3PoppinsRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 24);
const kH3PoppinsMedium = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 24);

const kH4PoppinsLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w300, fontSize: 20);
const kH4PoppinsRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 20);
const kH4PoppinsMedium = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 20);

const kH5PoppinsLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w300, fontSize: 18);
const kH5PoppinsRegular = TextStyle(fontFamily: 'Open Sans', fontWeight: FontWeight.w400, fontSize: 18);
const kH5PoppinsMedium = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 18);
...
const kH2TotalScoreLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 24, color: Color(0xFF5478ED));
const kH2TotalScoreRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 24, color: Color(0xFF5478ED));
const kH3TotalScoreLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 20, color: Color(0xFF5478ED));
const kH3TotalScoreRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 20, color: Color(0xFF5478ED));
const kH4TotalScoreLight = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400, fontSize: 15, color: Color(0xFF5478ED));
const kH4TotalScoreRegular = TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w500, fontSize: 15, color: Color(0xFF5478ED));
...
const kTextFieldHeaderTextStyle = TextStyle(fontFamily: "OpenSans", fontWeight: FontWeight.w400, fontSize: 16, color: Color(0xFF323232));

const kErrorTextFieldTextStyle = TextStyle(fontFamily: "OpenSans", fontWeight: FontWeight.w400, fontSize: 12, color: Color.fromARGB(255, 213, 0, 0));
...
const kInfoTextTextStyle = TextStyle(fontFamily: "OpenSans", fontWeight: FontWeight.w400, fontSize: 14, color: Color(0xFF494949));
